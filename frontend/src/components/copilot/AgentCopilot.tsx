...
export function AgentCopilot() {
  ...
  return (
    <div
      ...
      style={{ background: "oklch(0.16 0.014 240 / 0.55)" }}
    >
      {/* Header */}
      <div
      ...
      >
            ...
            {attachedImages.map((img) => (
              <div key={img.id} className="relative">
                ...
                <button
                  ...
                  onMouseLeave={(e) => {
                    e.currentTarget.style.background = "oklch(0.14 0.010 240)";
        ...
        >
          ...
          <button
            ...
            onMouseEnter={(e) => {
              if (!attachDisabled) {
                e.currentTarget.style.background = "oklch(0.26 0.012 240 / 0.6)";
                e.currentTarget.style.color = "var(--color-text)";
              }
            }}
            onMouseLeave={(e) => {
