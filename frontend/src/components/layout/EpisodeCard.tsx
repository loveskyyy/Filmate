  ...
  return (
    <button
      ...
      style={{
        ...
        marginBottom: 3,
        background: active
          ? "linear-gradient(180deg, oklch(0.22 0.016 220 / 0.55), oklch(0.18 0.014 218 / 0.40))"
          : "transparent",
        border: active ? "1px solid var(--color-accent-soft)" : "1px solid transparent",
        boxShadow: active
          ? "0 0 0 1px var(--color-accent-soft), 0 4px 12px -6px oklch(0 0 0 / 0.5), inset 0 1px 0 oklch(1 0 0 / 0.04), 0 0 16px -8px var(--color-accent-glow)"
          : "none",
      }}
      onMouseEnter={(e) => {
      ...
      <div
        ...
        style={{
          background: active
            ...
            : "linear-gradient(180deg, oklch(0.24 0.014 242), oklch(0.20 0.012 240))",
      ...
      <div className="min-w-0">
        ...
        {showProgress && (
          <div
            ...
            style={{ background: "oklch(0.20 0.012 240)" }}
          >
            <div
              className="h-full"
              style={{
