              ...
              <button
                ...
                onMouseEnter={(e) => {
                  if (!dup && !sel) {
                    ...
                    e.currentTarget.style.background = "oklch(0.22 0.011 240 / 0.7)";
                  }
                }}
                onMouseLeave={(e) => {
                  if (!dup && !sel) {
                    e.currentTarget.style.borderColor = "var(--color-hairline)";
                    e.currentTarget.style.background = "oklch(0.20 0.011 240 / 0.5)";
                  }
                }}
              >
