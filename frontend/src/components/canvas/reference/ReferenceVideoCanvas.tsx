  ...
  return (
    <div className="flex h-full min-h-0 flex-col">
      ...
      <div
        ...
        className="flex items-center gap-0.5 border-b border-[var(--color-hairline)] bg-[oklch(0.17_0.014_242_/_0.55)] px-5"
      >
        <button
          type="button"
          role="tab"
      ...
      {tab === "preproc" ? (
        <div className="min-h-0 flex-1 overflow-auto bg-[oklch(0.16_0.014_242_/_0.28)]">
        ...
        <div
          ref={workbenchRef}
          className="relative min-h-0 flex-1 overflow-hidden bg-[oklch(0.16_0.014_242_/_0.28)]"
        >
          <div className="grid h-full min-h-0" style={{ gridTemplateColumns: gridCols }}>
            ...
            <div className="flex min-h-0 flex-col overflow-hidden bg-[radial-gradient(ellipse_at_top,oklch(0.20_0.014_242_/_0.35),oklch(0.16_0.012_238_/_0.20))]">
              {selected ? (
                <>
                  <div className="flex flex-wrap items-center gap-2 border-b border-[var(--color-hairline-soft)] px-4 py-2.5">
                    ...
                    <span className="inline-flex items-center gap-1 rounded border border-[var(--color-hairline-soft)] bg-[oklch(0.20_0.014_242_/_0.65)] px-2 py-0.5 text-[11.5px] text-[var(--color-text-2)]">
                    ...
                    <button
                      ...
                      className="focus-ring inline-grid h-6 w-6 place-items-center rounded border border-[var(--color-hairline)] bg-[oklch(0.20_0.012_240_/_0.55)] text-[var(--color-text-2)] hover:bg-[oklch(0.82_0.16_200_/_0.10)] disabled:cursor-not-allowed disabled:opacity-50"
                    >
                  ...
                  {stackPreview && (
                    <div
                      ...
                      className="flex items-center gap-0 border-b border-[var(--color-hairline)] bg-[oklch(0.17_0.014_242_/_0.45)] px-5"
                    >
                      <button
                        type="button"
                        role="tab"
                  ...
                  <div className="flex min-h-0 flex-1 flex-col overflow-hidden">
                    {(!stackPreview || stackTab === "editor") && (
                      <div className="flex min-h-0 flex-1 flex-col overflow-hidden">
                        ...
                        {/* Editor bottom bar */}
                        <div className="flex flex-shrink-0 items-center gap-2 border-t border-[var(--color-hairline-soft)] bg-[oklch(0.16_0.012_240_/_0.55)] px-3.5 py-2">
                          <span
                          ...
                          <button
                            ...
                            className={`focus-ring inline-flex min-w-[80px] items-center justify-center gap-1.5 rounded-md px-3 py-1 text-xs font-semibold ${
                              isDirty
                                ...
                                : "border border-[var(--color-hairline)] bg-[oklch(0.20_0.012_240_/_0.55)] text-[var(--color-text-4)]"
                    ...
                    {stackPreview && stackTab === "preview" && (
                      <div className="flex min-h-0 flex-1 flex-col overflow-hidden bg-[linear-gradient(180deg,oklch(0.17_0.014_242_/_0.55),oklch(0.15_0.012_238_/_0.40))]">
                        <UnitPreviewPanel
                          unit={selected}
                          projectName={projectName}
            ...
            {!stackPreview && (
              <div className="flex min-h-0 flex-col overflow-hidden border-l border-[var(--color-hairline)] bg-[linear-gradient(180deg,oklch(0.17_0.014_242_/_0.55),oklch(0.15_0.012_238_/_0.40))]">
                <UnitPreviewPanel
                  unit={selected}
                  projectName={projectName}
