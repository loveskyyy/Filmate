    ...
    return (
      <div
        ...
        style={{
          ...
          background: "oklch(0.17 0.014 242 / 0.55)",
        }}
      >
        <button
          type="button"
            ...
            return (
              <button
                ...
                className={`absolute left-0 right-0 grid w-full items-center gap-2.5 rounded-lg p-2 text-left transition-colors focus-ring ${
                  active ? "" : "hover:bg-[oklch(0.82_0.16_200_/_0.07)]"
                }`}
                style={{
                ...
                >
                  {sbUrl ? (
                    ...
                    <div
                      ...
                      style={{
                        background:
                          "linear-gradient(135deg, oklch(0.26 0.06 220), oklch(0.16 0.04 235))",
                      }}
                    />
                  )}
                  <span
                  ...
                  <div className="flex items-center gap-1.5">
                    ...
                    {contentMode === "ad" && (seg as AdShot).section && (
                      <span
                        ...
                        style={{
                          color: "var(--color-accent-2)",
                          background: "oklch(0.26 0.018 238 / 0.45)",
